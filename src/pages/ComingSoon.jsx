  ...
  return (
    <div className="flex flex-col items-center mx-auto md:w-4/5">
      ...
      <div className="-mt-20 mb-20 lg:-mt-48 flex flex-col gap-12 w-3/4 md:w-3/6 p-4">
        ...
        <div className="mb-4 leading-8 font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-bl from-slate-200 to-slate-900 text-5xl sm:text-6xl ">
          Coming Soon.
        </div>
